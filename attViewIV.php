...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sqlAttendance = "SELECT * FROM attendancerecordiv WHERE subject = '$selectedSubject' ORDER BY date";
...
<div class="scrollable-table-container">
    ...
    if (isset($resultAttendance) && $resultAttendance->num_rows > 0) {
        ...
        $extraRollNumbers = array(301, 302, 303, 351, 352, 353, 354, 355, 356, 357, 401, 402, 602, 603, 604, 606);
